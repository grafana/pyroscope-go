...
func getFunctionPointers() []uintptr {
	return []uintptr{
		...
		reflect.ValueOf(assert.EqualExportedValues).Pointer(),
		reflect.ValueOf(assert.EqualExportedValuesf).Pointer(),
		...
		reflect.ValueOf(assert.ErrorContains).Pointer(),
		reflect.ValueOf(assert.ErrorContainsf).Pointer(),
		...
		reflect.ValueOf(assert.EventuallyWithT).Pointer(),
		reflect.ValueOf(assert.EventuallyWithTf).Pointer(),
		...
		reflect.ValueOf(assert.ObjectsExportedFieldsAreEqual).Pointer(),
		...
		reflect.ValueOf(assert.WithinRange).Pointer(),
		reflect.ValueOf(assert.WithinRangef).Pointer(),
